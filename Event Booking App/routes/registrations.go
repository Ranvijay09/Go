...
func cancelRegistration(context *gin.Context) {
	...
	if err != nil {
		context.JSON(http.StatusInternalServerError, gin.H{"message": "Could not deregister event"})
		return
	}

	context.JSON(http.StatusOK, gin.H{"message": "Event deregistration successful."})
}
